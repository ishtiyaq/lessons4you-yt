# How to setup cloudflare argo tunnel
...
[![![](http://192.168.0.118:6875/loading.gif#uploadimage-960faa02d8a19)](http://192.168.0.118:6875/uploads/images/gallery/2022-09/scaled-1680-/image-1662814595411.png)](http://192.168.0.118:6875/uploads/images/gallery/2022-09/image-1662814595411.png)
...
You will get permission denied error, in this case just copy your `config.yml` file to `/etc/cloudflared/` directory.

```bash
sudo cp ~/.cloudflared/config.yml /etc/cloudflared/config.yml
```

Or, update `config.yml` location in service file.
